...
public class T04ErrorHandler extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Integer statusCode = (Integer) req.getAttribute("javax.servlet.error.status_code"); // 상태코드
		...
		if(throwable == null && statusCode == null) {
			...
			out.println("<p>상태코드: " + reqURI+ "</p><br><br>");
			
			if(statusCode != null) {
				out.print("<p>예외 타입: " + throwable.getClass().getName() + "</p><br><br>");
				out.print("<p>예외(에러) 메시지: " + throwable.getMessage() + "</p>");
			}
			out.print("</body></html>");
		}
