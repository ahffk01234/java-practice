...
public class MultiChatServer2 {
	...
	public void secretMessege(String msg) {
		Iterator<String> it = clients.keySet().iterator();
	...
	public void whisperMessege(String name, String msg) {
		secretMessege(name+"님이 보낸 귓속말" +msg);
			...
			try {
				...
				while(dis != null) {
					...
					if(messege.startsWith("/")) {
						whisperMessege(name,messege);
					}
					else {
					sendMessege(messege, name);
					}
				}
			}catch(IOException ex) {
				ex.printStackTrace();
	...
	public static void main(String[] args) {
		new MultiChatServer2().serverStart();
	}
