...
public class T14ThreadShareDataTest {
	...
	public static void main(String[] args) {
		...
		Thread cPT = new CalcPIThread(sd);
		Thread pPT = new PrintPIThread(sd);
...
private double result; // 계산된 원주율이 저장될 변수
	...
	private volatile boolean isOk; // 원주율 계산이 완료되었는지를 나타내기 위한 변수
	/*
	    volatile => 선언된 변수를 컴파일러의 최적화 대상에서 제외시킨다.
	             즉, 값이 변경되는 즉시 변수에 적용시킨다.
	             다중스레드에서 하나의 변수가 완벽하게 한번에 작동하도록 보장하는 키워드(일종의 동기화) 
	*/
