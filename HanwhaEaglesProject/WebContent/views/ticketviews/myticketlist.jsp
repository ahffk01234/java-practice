                ...
                <a href="" class="nav-link text-white">
				    <div class="row collapse navbar-collapse board-div">
                         <ul class="navbar-nav content-div board_menu">	     
                            ...
                            <li class="col col-1" id="PCFAFT"><a href="http://localhost:8888/myticketPay.do" class="nav-link"><span style="width: 0px; color:orange;">티켓예매내역</span></a></li>
			...
			<nav class="content-header navbar-expand-lg" style="padding: 0px 10px 0px 10px;">
				<div class="row collapse navbar-collapse">
					<ul class=" navbar-nav content-div board_menu">					
						...
						<li class="col col-8" id="PCFACN"><h1 class="text-white" style="font-style: bold;"><span style="font-weight: bold;">티켓예매 내역</span>을 확인하실 수 있습니다.</h1></li>
					</ul>
					</div>
				</div>
			</nav>
							...
							<li class="col col-10">
								<div class="row collapse navbar-collapse">
									<ul class="navbar-nav content-div board_menu" style="border: 1px solid white; border-radius: 10px; height: 70px; text-align: center;
										...
										<li class="col col-1 board-list" style="color: gray;"><span style="width: 0px;">티켓코드</span></li>
								...
								<li class="col col-10">
									<div class="row collapse navbar-collapse board-idv">
										<ul class="navbar-nav content-div board_menu" style="padding: 0px 3px 0px 3px;">
                                            ...
                                            <li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                                                <a href="" class="nav-link text-white"><span style="width: 0px;"><%=ticketCd %></span></a></li>
											<li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
												<a href="" class="nav-link text-white"><span style="width: 0px;"><%=tp.getTicketPayCd()%></span></a></li>
											<li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
											...
											<li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
												<a href="" class="nav-link text-white"><span style="width: 0px;"><%=ticketPayOk %></span></a></li>
                                            <li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                                            ...
                                            <li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                                                <button type="button" class="btn btn-primary deletePay" style="font-size: 0.8em;" onclick="Modal(<%=ticketCd%>,<%=ticketPayCd%>)">취소하기</button></li>  
...
<!-- 							<form id="payForm" action="/deleteTicket.do" method="POST"> -->
<!-- 							<button type="button" class="btn btn-outline-light" onclick="payBtnClicked()">결제하기</button> -->
<!-- 							</form> -->
<!-- 							</span></li> -->
<!-- 						</ul> -->
<!-- 					</div> -->
<!-- 				</nav> -->
		...
		<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel" aria-hidden="true">
   			<div class="modal-dialog modal-dialog-centered" role="document">
        		<div class="modal-content bg-black text-white">
            		<div class="modal-header" style="border-bottom-color: orange;">
                		...
                		<form action="deleteTicket.do" method="POST" id="delete">
							<input type="hidden" id="ticketCd" name="ticketCd">
							<input type="hidden" id="ticketPayCd" name="ticketPayCd">
...
<script>
function Modal(ticketCd,ticketPayCd){
	var myModal = new bootstrap.Modal(document.getElementById('deleteModal'));
	document.getElementById('ticketCd').value = ticketCd;
	document.getElementById('ticketPayCd').value = ticketPayCd;
	myModal.show();
	};
