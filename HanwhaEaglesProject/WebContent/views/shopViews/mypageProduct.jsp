...
<%
   List<MypageProductVO> myProductList = (List<MypageProductVO>)request.getAttribute("showMypageProduct");
%>    
      ...
      <nav class="content-header navbar-expand-lg" style="padding: 40px 10px 0px 10px;">
                ...
                <div class="row collapse navbar-collapse board-div">
                         <ul class="navbar-nav content-div board_menu">        
                            ...
                            <li class="col col-1" id="PCFACN"><a href="http://localhost:8888/mypage/productList.do" class="nav-link"><span style="width: 0px; color:orange;">굿즈구매내역</span></a></li>
         ...
         <nav class="content-header navbar-expand-lg" style="padding: 0px 10px 0px 10px;">
            <div class="row collapse navbar-collapse">
               <ul class=" navbar-nav content-div board_menu">               
                  ...
                  <li class="col col-8" id="PCFACN"><h1 class="text-white" style="font-style: bold;"><span style="font-weight: bold;">굿즈구매 내역</span>을 확인하실 수 있습니다.</h1></li>
               </ul>
               </div>
            </div>
         </nav>
                     ...
                     <li class="col col-10">
                        <div class="row collapse navbar-collapse">
                           <ul class="navbar-nav content-div board_menu" style="border: 1px solid white; border-radius: 10px; height: 70px; text-align: center;
                              ...
                              <li class="col col-1 board-list" style="color: gray;"><span style="width: 0px;">구매날짜</span></li>
                           </ul>
                        </div>
                     </li>
               </ul>
                           ...
                           <div class="row collapse navbar-collapse board-idv">
                              <ul class="navbar-nav content-div board_menu" style="padding: 0px 3px 0px 3px;">
                                 <li class="col col-6 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                                    <a href="http://localhost:8888/shop/product.do?ProdCd=<%=mpv.getProdCd() %>	" class="nav-link text-white"><span class="prod-name"style="width: 0px;"><%=mpv.getProdName() %></span></a></li>
                                 ...
                                 <li class="col col-1 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                                    <a href="" class="nav-link text-white"><span style="width: 0px;"><%=mpv.getNumPrice() %></span></a></li>
                                            ...
                                            <% 
                                          	  ...
                                          	  String mpvCartDate = dateFormat.format(mpv.getCartDate());
                                            %>
                                                <a href="" class="nav-link text-white"><span class="basket-day" style="width: 0px;"><%=mpvCartDate %></span></a></li>
                              </ul>
                           </div>
                        </li>
                  </ul>
