...
String sessionId = (String)request.getAttribute("memID");
...
<%				
            ...
            for(TalkVO tv : talkList){
        		...
        		String date = sdf.format(tv.getTalkDate());	
        		
        		if(sessionId.equals(tv.getMemId())){
%>
					<div class="col-4"></div>
        			<div class="row col-7" style="margin: 10px; border: 2px solid orange; border-radius: 10px;">
<%        		}else{
%>					
					<div class="row col-7" style="margin: 10px; border: 0.5px solid white; border-radius: 10px;">
...
%>
	            	...
	            	<div id="comment-section" class="col-7 text-white text-center">
	            	<br>
	            	<%=tv.getTalkContent() %>
	            	<br><br>
	            	</div>
	            	
	            	<div class="col-3 text-white text-center" style="font-size: 10px;">
	            	<br><br>
	            	...
	            	<div class="col-2 text-white text-center" style="font-size: 10px;">
	            	<br><br>
	            	<%=date %>
	            	<br><br>
	            	</div>
    ...
    <div class="modal" id="confirmModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content bg-black text-white">
                ...
                <div class="modal-body">
                    승부 예측에 성공하면 추첨을 통해 티켓 할인 쿠폰이 증정됩니다.
                </div>
                <div class="modal-footer" style="border-top-color: orange;">
...
$(document).ready(function() {
  $('#gameresultsubmit').click(function() {
    // AJAX 요청 실행
    var resultData = $('#resultInput').val();
    $.ajax({
      url: '/gameresult.do?data=6:2',  // 요청을 보낼 URL
      ...
      success: function(response) {
        ...
        // 모달 창 닫기
		window.location.href = '/gameresult.do?data=6:2';  // 새로운 URL로 이동 
      },
      error: function(xhr, status, error) {
        // 요청이 실패했을 때 실행할 코드
