...
<nav class="container-fluid content-board bg-black">
  ...
  <span id="bdCode" style="display: none;"><%=bv.getBoardCd() %></span>
  <span id="existingImg" style="display: none;"><%=bv.getBoardImg() %></span>
         ...
         <div class="notice_write" >
            <div class="list_form">
               <div class="row_hr" style="height: 50px;">
                  ...
                  <div class="item_row">
                     <div class="input_wrap textarea" >
                        <textarea class="form-control" rows="1" name="title" id="title"><%=bv.getBoardTitle() %></textarea>
                     </div><!-- //.input_wrap -->
                  </div>
               </div>
               ...
               <label for="title" class="text-white">내용
                  ...
                  <div class="item_row">
                     <div class="input_wrap textarea">
                        <textarea class="form-control" rows="20" name="content" id="content"><%=bv.getBoardContent() %></textarea>
                     </div><!-- //.input_wrap -->
                     <div class="list_bul">
...
<div class="paginate btn_area center" id="insertBtn">
         ...
         <button type="button" onclick="insertBoard()" class="btn_com em">수정</button>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content bg-black text-white" style="border: 2px solid white">
      <div class="modal-header" style="border-bottom-color: orange;">
        <h5 class="modal-title" id="loginModalLabel">게시물 수정</h5>
...
$('#yesBtn').on('click', function(){
	var bdCode = document.getElementById("bdCode").innerText;
    var existingImg = document.getElementById("existingImg").innerText;
    var title = $('#title').val();
