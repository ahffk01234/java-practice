            ...
            <a href="" class="nav-link text-white">
                <div class="row collapse navbar-collapse board-div">
                    <ul class="navbar-nav content-div board_menu">
                        ...
                        <li class="col col-1" id="PCFACN" style="margin-right: 40px;"><a href="/BoardMain.do" class="nav-link"><span style="width: 0px; color:orange;">팬 타임즈</span></a></li>
...
<nav class="container-fluid content-board bg-black">
    <div class="content-boarddiv">
            ...
            <div class="row collapse navbar-collapse">
                <ul class=" navbar-nav content-div board_menu" style="margin-top: 50px;">
                    ...
                    <li class="col col-8" id="PCFACN">
                        <h1 class="text-white" style="font-weight: bold;"><span style="font-weight: bold; ">팬 타임즈</span></h1>
                    </li>
                </ul>
            </div>
        </nav>
                    ...
                    <li class="col col-10">
                        <div class="row collapse navbar-collapse">
                            <ul class="navbar-nav content-div board_menu" style="border: 1px solid white; border-radius: 10px; height: 70px; text-align: center; padding: 20px 3px 0px 3px;">
                                ...
                                <li class="col col-2 board-list" style="color: white; font-size: 1.1em;"><span style="width: 0px;">게시일자</span></li>
                                <li class="col col-2 board-list" style="color: white; font-size: 1.1em;"><span style="width: 0px;">좋아요</span></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <!-- 게시물 생성 구간 -->
<%
    ArticlePage articlePage = (ArticlePage) request.getAttribute("bdList");
    List<BoardVO> bdList = (articlePage != null) ? articlePage.getContent() : null;
    int bdSize = (bdList != null) ? bdList.size() : 0;
    if (bdSize == 0) {
%>
                    ...
                    <div class="row collapse navbar-collapse board-idv">
                        <ul class="navbar-nav content-div board_menu" style="padding: 0px 3px 0px 3px;">
                            ...
                            <li class="col col-4 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                                <a href="" class="nav-link text-white"><span class="prod-name" style="width: 0px;">조회된 팬 타임즈 게시물이 없습니다.</span></a>
                            </li>
                            <li class="col col-2 board-list" style="color: gray; text-align: center; font-size: 0.8em;">
                    ...
                    <div class="row collapse navbar-collapse board-idv">
                        <ul class="navbar-nav content-div board_menu" style="padding: 0px 3px 0px 3px;">
                            <li class="col col-2 board-list" style="color: white; text-align: center; font-size: 0.9em;">
                                <span class="prod-name" style="width: 0px;"><%=bd.getBoardCd() %></span>
                            </li>
                            <li class="col col-4 board-list" id="<%=bd.getBoardCd() %>" onclick="redirectToOtherPage('<%=bd.getBoardCd() %>')" name="<%=bd.getBoardCd() %>" style="color: white; text-align: center; font-size: 0.9em; cursor: pointer;">
                                <span id="titlehover" class="prod-name" style="width: 0px;"><%=bd.getBoardTitle() %></span>
                            </li>
                            <li class="col col-2 board-list" style="color: white; text-align: center; font-size: 0.9em;">
                                <span><%=mv.getMemNickname() %></span>
                            </li>
                            <li class="col col-2 board-list" style="color: white; text-align: center; font-size: 0.9em;">
                                <span style="width: 0px;"><%=bd.getBoardDate() %></span>
                            </li>
                            <li class="col col-2 board-list" style="color: white; text-align: center; font-size: 0.9em;">
                                <span style="width: 0px;"><%=likeTotal %></span>
                            </li>
...
%>
        ...
        <nav aria-label="Page navigation example" class="d-flex justify-content-center">
            <ul class="pagination">
                ...
                <c:forEach var="pNo" begin="${bdList.startPage}" end="${bdList.endPage}" varStatus="stat">
                    <li class="page-item"><a class="page-link" id="pageCss" style="background-color: black; color: white; border: 2px solid #f37321;" href="/BoardMain.do?bdcurrentPage=${pNo}">${pNo}</a></li>
                </c:forEach>
        ...
        if(logMemId != null){
        	MemberVO mv = new MemberVO();
            IMemberService memService = MemberServiceImpl.getInstance();
        	mv = memService.getMember(logMemId);
        	String memBlack = mv.getMemBlack();
...
<script>
function redirectToOtherPage(boardCd) {
    console.log("boardCd:", boardCd); // 콘솔 로그 추가
    var newUrl = 'http://localhost:8888/ReadBoard.do?boardCd=' + boardCd;
