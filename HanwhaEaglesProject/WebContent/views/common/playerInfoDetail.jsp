	    ...
	    <nav class="container-fluid content-board bg-black backG">
	    	<nav class="content-header navbar-expand-lg" style="padding: 40px 10px 0px 40px;">
                  ...
                  <nav class="container-fluid content-board bg-black">
				    <div class="row collapse navbar-collapse board-div">
                         <ul class="navbar-nav content-div board_menu">
                         	<li class="col col-1"></li>
                         	<li class="col col-7">
                         		<img class="backimg" src="../../img/player/twoSoo/문동주3627.png">
                         	</li>
                         	<li calss="col col-5" text-white; style="position:relative;"> 
								<span style="position:relative; font-size:5em; top:70px;">1 문동주</span> 
								<span style="position:relative; font-size:2.7em; top:40px; color:gray">MOON DONGJU</span>

								
								<img src="../../img/player/Others/ico_player_pitcher.png" style="position:relative; width:30%; top:40px;">
								<span style="position:relative; font-size:1.5em; top:50px;">투수  우투우타</span><br><br><br><br>
								
								<span style="position:relative; font-size:1.5em;">생년월일</span><br><span style="position:relative; font-size:1.0em; color:gray;">2003, 12, 23</span><br><br>								
								<span style="position:relative; font-size:1.5em;">체격</span><br><span style="position:relative; font-size:1.0em; color:gray;">188cm, 97kg</span><br><br>
								<span style="position:relative; font-size:1.5em;">출신학교</span><br><span style="position:relative; font-size:1.0em; color:gray;">광주화정초-광주무등중-광주진흥고</span><br><br>
								<span style="position:relative; font-size:1.5em;">주요경력</span><br><span style="position:relative; font-size:1.0em; color:gray;">2022 한와이글스 입단</span>	<br><br>							
	    		...
	    		<nav class="content-header navbar-expand-lg" style="padding: 40px 10px 0px 40px;">                	
                	...
                	<li class="col col-9">
                	<li class="col col-2">
                	<a href="http://localhost:8888/players/TwoSoo.do" class="nav-link text-white"><span style="border:1px solid white; border-radius:10px; font-size:2em;">&nbsp;&nbsp;목록&nbsp;&nbsp;</span></a>>
                	</li>
                	</ul>
                </a>
			</nav>
