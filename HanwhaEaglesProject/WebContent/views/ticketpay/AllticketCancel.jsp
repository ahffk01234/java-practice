...
<!--                 <a href="" class="nav-link text-white" style="visibility:hidden"> -->
                    <div class="row collapse navbar-collapse board-div">
                         <ul class="navbar-nav content-div board_menu">	     
                         	<li class="col col-1" id="PCFACN"><!-- <a href="" class="nav-link text-white" style="visibility:hidden"> --><span style="width: 0px;"></span> </a></li>                				
                            ...
                            <li class="col col-1" id="PCFAFT" style="margin-right: 30px;"><a href="/AllTicketPay.do" class="nav-link text-white"><span style="width: 0px;"></span>전체 티켓예매 내역</a></li>
                            <li class="col col-1" id="PCFACN" style="margin-right: 30px;"><a href="/AllPayCancel.do" class="nav-link"><span style="width: 0px; color: orange;">전체 티켓환불 내역</span></a></li>
                        </ul>
                      </div>
                </a>
			</nav>
         ...
         <nav class="content-header navbar-expand-lg" style="padding: 0px 10px 0px 10px;">
            <div class="row collapse navbar-collapse">
               <ul class=" navbar-nav content-div board_menu" style="margin-top: 50px;">               
                  ...
                  <li class="col col-8" id="PCFACN"><h1 class="text-white" style="font-style: bold;"><span style="font-weight: bold; ">전체 티켓환불 내역</span></h1></li>
               </ul>
               </div>
                     ...
                     <li class="col col-10">
                        <div class="row collapse navbar-collapse">
                           <ul class="navbar-nav content-div board_menu" style="border: 1px solid white; border-radius: 10px; height: 70px; text-align: center;
                              ...
                              <li class="col col-2 board-list" style="color: white; font-size: 1.1em;"><span style="width: 0px;">총가격</span></li>
                              <li class="col col-1 board-list" style="color: white; font-size: 1.1em;"><span style="width: 0px;">결제여부</span></li>
                              <li class="col col-2 board-list" style="color: white; font-size: 1.1em;"><span style="width: 0px;">결제수단</span></li>
                ...
                <li class="col col-10">
                    <div class="row collapse navbar-collapse board-idv">
                        <ul class="navbar-nav content-div board_menu" style="padding: 0px 3px 0px 3px; color: white; font-size: 15px;">
                                ...
                                <li class="col col-1 board-list" style="text-align: center;">
                                    <span style="width: 0px;" ><%=tp.getTicketPayOk() %></span>
                                </li>
                                <li class="col col-2 board-list" style="text-align: center;">
