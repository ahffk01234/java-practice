...
<nav class="container-fluid content-board bg-black" style="margin-top: 0px; height: 100%; ">
    <div class="content-boarddiv" >

        <nav class="content-header navbar-expand-lg" id="alldiv" style="padding: 0px 10px 0px 10px; margin-bottom: 30px;">
                ...
                <ul class="navbar-nav content-div board_menu" style="margin-top: 80px;">
                    ...
                    <li class="col col-8" id="PCFACN">
                        <h1 class="text-white" style="font-style: bold;">
                            <span style="font-weight: bold;  margin-bottom: 35px; margin-left: 150px;">구단 소식 작성</span>
                        </h1>
                    </li>
                </ul>
            </div>
...
<ul class="navbar-nav content-div board_menu blank-black" style="margin-top:80px;">
</ul>
<ul class="navbar-nav content-div board_menu blank-black" style="margin-top:80px;">
</ul>
</div>    
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content bg-black text-white" style="border: 2px solid white">
      <div class="modal-header" style="border-bottom-color: orange;">
        <h5 class="modal-title" id="loginModalLabel">구단 소식 등록</h5>
