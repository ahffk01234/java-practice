...
// 티켓 환불내역
@WebServlet("/AllPayCancel.do")
public class AllPayCancelController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<TicketPayVO> myticketPayList = ticketpayService.getAllCancelTicket();
		
		req.setAttribute("myTicketList", myticketPayList);

		resp.setCharacterEncoding("utf-8");

		RequestDispatcher rd = req.getRequestDispatcher("/views/ticketpay/AllticketCancel.jsp");
		rd.forward(req,resp);
	}
