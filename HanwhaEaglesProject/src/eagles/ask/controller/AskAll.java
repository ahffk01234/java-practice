...
@WebServlet (value= "/ask/getAskAll.do")
public class AskAll extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<AskVO> askList = askService.getAskAll();

		
		System.out.println(memId);		
		System.out.println(askList);
		
		req.setAttribute("getAskAll", askList);
		
		RequestDispatcher rd = req.getRequestDispatcher("/views/ask/getAskAll.jsp");
		rd.forward(req, resp);
	}
